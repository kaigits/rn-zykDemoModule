...
@implementation ZykStaticExample
...
RCT_EXPORT_MODULE(ZykStaticExample);
...
- (dispatch_queue_t)methodQueue {
    return dispatch_queue_create("com.zykai.rntest", DISPATCH_QUEUE_SERIAL);
}


//导出常量
- (NSDictionary *)constantsToExport {
    return @{ @"ZYKModuleName" : @"ZykStaticExample",
